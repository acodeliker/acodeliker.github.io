...
i. Because in C++, if you customize these 5 functions, the compiler will no longer generate default related functions for you. But if we add the =default keyword at the end, You can retrieve and use the default function generated by the compiler (explicit default: tell the compiler to generate the default default version of the function even if you define it yourself)
